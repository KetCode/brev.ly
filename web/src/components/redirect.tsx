  ...
  return (
    <div className="flex justify-center items-center w-full px-3">
      <div className="flex flex-col justify-center sm:px-12 px-5 sm:py-16 py-12 gap-6 bg-gray-100 rounded-lg w-145">
        ...
        <span className="font-bold text-2xl text-[#1F2025] flex items-center justify-center text-center">
          Redirecionando...
        </span>

        <div className="flex flex-col items-center gap-1">
          <p className="font-semibold text-sm text-center self-stretch text-[#4D505C]">
